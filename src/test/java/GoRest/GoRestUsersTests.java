...
public class GoRestUsersTests {
    ...
    void Setup(){
        ...
        baseURI="https://gorest.co.in/public/v2/";//  baseURI="https://gorest.co.in/public/v2/users" kullanirsak post bos kalabilir
    ...
    public void createUserObject()
    {
        ...
        userID=
                given()
                        ...
                        .header("Authorization","Bearer 2890b8cf9ca84e50c9d0a855be1cd397b4c41ccc80c69f43739a885ebcca07ed")
                       ...
                       .post("users")
                        ...
                        .contentType(ContentType.JSON)
                        //.extract().path("id")
                        .extract().jsonPath().getInt("id")   // jsonPath : class dönüşümüne ve tip( int double..) dönüşümüne izin vererek , veriyi istediğimiz formatta verir.
        ;
    ...
    public void updateUserObject()
    {
       ...
       updateUser.put("name","scooby doo");

       //  newUser.setName("scooby doo ");
    ...
    public void deleteUserByIdNegative()//burda hata alinirsa dependicies e sunu ekle <argLine>-Duser.language=en</argLine>
    {
        given()
                .header("Authorization","Bearer 2890b8cf9ca84e50c9d0a855be1cd397b4c41ccc80c69f43739a885ebcca07ed")
                .contentType(ContentType.JSON)
