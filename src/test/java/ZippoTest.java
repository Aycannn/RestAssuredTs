...
//    body.places[0].state -> body("places[0].state"
    ...
    public void queryParamTest() {
       //https://gorest.co.in/public/v1/users?page=1
        ...
        given()
                .param("page",1)
                .log().uri() //request linki gösterir run da,yani gitmeden önceki link

                .when()
                .get("https://gorest.co.in/public/v1/users")

                .then()
                .log().body()//log asagida yazdirir belirtilen yeri mesela burada body i yazdirir
    ...
    public void queryParamTest2() {
        ...
        for (int pageNo = 1; pageNo <= 10; pageNo++) {
            given()
                    .param("page", pageNo)
                    .log().uri() //request linki gösterir.yani gitmeden önceki linki
    ...
    public void extractingJsonPath() {
        ...
        given()
                ...
                //.log().body()
                .statusCode(200)
                .extract().path("places[0].'place name'")//sadece place name alindi,0.indexteki
    ...
    public void extractingJsonPathStringList() {
        ...
        Assert.assertTrue(isimler.contains("Vidhya Ganaka"));
    }
